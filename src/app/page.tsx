            ...
            <div className="mb-8 animate-fade-in-up stagger-3">
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
                ...
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-blue-200 dark:border-blue-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-blue-400 dark:group-hover:border-blue-300">
                    <Image
                      src="/images/ustadzfikri.png"
                      alt="Ustadz Fikri"
                      width={96}
                      height={96}
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Ustadz Fikri</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-purple-200 dark:border-purple-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-purple-400 dark:group-hover:border-purple-300">
                    <Image
                      src="/images/rian.png"
                      alt="Rian"
                      width={96}
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Rian</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-pink-200 dark:border-pink-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-pink-400 dark:group-hover:border-pink-300">
                    <Image
                      src="/images/rara.png"
                      alt="Rara"
                      width={96}
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors">Rara</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-green-200 dark:border-green-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-green-400 dark:group-hover:border-green-300">
                    <Image
                      src="/images/pastorsamuel.png"
                      alt="Pastor Samuel"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">Pastor Samuel</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-orange-200 dark:border-orange-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-orange-400 dark:group-hover:border-orange-300">
                    <Image
                      src="/images/nofrianto.png"
                      alt="Nofrianto"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">Nofrianto</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-red-200 dark:border-red-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-red-400 dark:group-hover:border-red-300">
                    <Image
                      src="/images/idawulan.png"
                      alt="Ida Wulan"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">Ida Wulan</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-yellow-200 dark:border-yellow-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-yellow-400 dark:group-hover:border-yellow-300">
                    <Image
                      src="/images/bhantedhammasila.png"
                      alt="Bhante Dhammasila"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors">Bhante Dhammasila</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-indigo-200 dark:border-indigo-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-indigo-400 dark:group-hover:border-indigo-300">
                    <Image
                      src="/images/ardi.png"
                      alt="Ardi"
                      width={96}
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Ardi</p>
                </div>
                
                <div className="text-center group cursor-pointer">
                  <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 mx-auto mb-3 rounded-full overflow-hidden border-3 border-teal-200 dark:border-teal-700 transition-transform duration-300 group-hover:scale-110 group-hover:border-teal-400 dark:group-hover:border-teal-300">
                    <Image
                      src="/images/andang.png"
                      alt="Andang"
                      width={96}
                      height={96}
                      className="w-full h-full object-cover"
                  ...
                  <p className="text-sm md:text-base font-medium text-gray-700 dark:text-gray-300 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">Andang</p>
                </div>
              </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" style={{minHeight: '200px'}}>
            ...
            <div className="feature-card group bg-gray-900 dark:bg-black p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 animate-fade-in-up stagger-2 relative overflow-hidden">
              ...
              <div className="absolute bottom-0 right-0 w-1 h-full bg-gradient-to-b from-purple-500 to-pink-500"></div>
